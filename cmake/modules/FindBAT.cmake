...
FOREACH(COMPONENT  ${BAT_FIND_COMPONENTS} )
        ...
        if ( BAT_LIBRARY_${UPPERCOMPONENT}_FOUND )
          ...
          set(BAT_LIBRARIES_SHARED ${BAT_LIBRARIES_SHARED} ${BAT_${UPPERCOMPONENT}_LIBRARY_SHARED})
          set(BAT_LIBRARIES_STATIC ${BAT_LIBRARIES_STATIC} ${BAT_${UPPERCOMPONENT}_LIBRARY_STATIC})
