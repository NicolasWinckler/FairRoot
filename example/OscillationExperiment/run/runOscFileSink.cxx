...
typedef BoostDeSerializer<OscMCPoint,TClonesArray*>     TInputPolicy; // boost non pod, return TClonesArray*
typedef RootOutFileManager<OscMCPoint>                  TOutputPolicy; // root non pod
